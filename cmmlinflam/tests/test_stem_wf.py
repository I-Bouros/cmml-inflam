...
class TestStemWF(unittest.TestCase):
    """
    Test the 'StemWF' class.
    """
    ...
    def test_simulate_criterion(self):
        ...
        criterion = [[0.1, 0.8, None], ['more', 'less', None]]
...
class TestStemWFTIMEVAR(unittest.TestCase):
    """
    Test the 'StemWFTIMEVAR' class.
    """
    def test__init__(self):
        algo = ci.StemWFTIMEVAR()
        self.assertEqual(
            algo._output_names,
            ['WT', 'A', 'B'])
        self.assertEqual(
